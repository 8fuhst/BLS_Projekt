...
public class Verdict {
    ...
    this.title = "Gerichtskosten für eine Wiederaufnahmeklage"; // Titelzeile
    this.keysentence = "NV: Die Vorschriften des GKG sind abschließend. Eine über die Tatbestände des Kostenverzeichnisses der Anlage 1 zum GKG hinausgehende Auferlegung von Gerichtskosten ist daher unzulässig."; // Leitsatz
    this.miscsentence = "Dies ist ein Sonst-O-Satz"; // Sonstosatz
    this.tenor = "Die Erinnerung gegen die Kostenrechnung des Bundesfinanzhofs -Kostenstelle- vom 28.08.2020 - KostL 993/20 (X K 6/19) wird zurückgewiesen.\n" +
            "\n" +
            "Die Entscheidung ergeht gerichtsgebührenfrei.";
    this.offense = "1. Die Klägerin nimmt den beklagten Fahrzeughersteller auf Schadensersatz wegen Verwendung einer unzulässigen Abschalteinrichtung für die Abgasreinigung in Anspruch.\n" +
